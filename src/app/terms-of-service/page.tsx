export default function Page() {
    return (
        <div className="prose max-w-4xl mx-auto p-6 space-y-4">
            ...
            <p><strong>Last updated:</strong> December 09, 2025</p>

            <h2>AGREEMENT TO OUR LEGAL TERMS</h2>

            <p>We are ICSSC (<strong>"Company"</strong>, <strong>"we"</strong>, <strong>"us"</strong>, <strong>"our"</strong>), a company registered in California, United States at 4208 DONALD BREN HALL, Irvine, CA 92620.</p>

            <p>We operate the website <a href="https://www.icssc.club" target="_blank" rel="noopener noreferrer">https://www.icssc.club</a> (the <strong>"Site"</strong>), the mobile application ICSSC (the <strong>"App"</strong>), as well as any other related products and services that refer or link to these legal terms (the <strong>"Legal Terms"</strong>) (collectively, the <strong>"Services"</strong>).</p>

            <p>You can contact us by email at <a href="mailto:icssc@uci.edu">icssc@uci.edu</a> or by mail to 4208 DONALD BREN HALL, Irvine, CA 92620, United States.</p>

            <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (<strong>"you"</strong>), and ICSSC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>

            <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <a href="mailto:icssc@uci.edu">icssc@uci.edu</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
            ...
            <p>This document has been created with external references and the help of the <a href="https://termly.io/products/terms-and-conditions-generator/" target="_blank" rel="noopener noreferrer">Termly Terms and Conditions Generator</a>.</p>
            ...
            <p>Subject to your compliance with these Legal Terms, including the <strong>"PROHIBITED ACTIVITIES"</strong> section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
            ...
            <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:icssc@uci.edu">icssc@uci.edu</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
            ...
            <p>Please review this section and the <strong>"PROHIBITED ACTIVITIES"</strong> section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
            ...
            <p><strong>Contributions:</strong> The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality during which you may create, submit, post, display, transmit, publish, distribute, or broadcast content and materials to us or through the Services, including but not limited to text, writings, video, audio, photographs, music, graphics, comments, reviews, rating suggestions, personal information, or other material (<strong>"Contributions"</strong>). Any Submission that is publicly posted shall also be treated as a Contribution.</p>
            ...
            <p>The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality, and may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Services, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, <strong>"Contributions"</strong>). Contributions may be viewable by other users of the Services and through third-party websites. As such, any Contributions you transmit may be treated as non-confidential and non-proprietary. When you create or make available any Contributions, you thereby represent and warrant that:</p>
            ...
            <p>We care about data privacy and security. Please review our Privacy Policy: <strong><a href="https://studentcouncil.ics.uci.edu/privacy-policy" target="_blank" rel="noopener noreferrer">https://studentcouncil.ics.uci.edu/privacy-policy</a></strong>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
            ...
            <h2 id="sms">22. SMS TEXT MESSAGING</h2>

            <h3>Program Description</h3>

            <p>By opting into any ICSSC text messaging program, you expressly consent to receive text messages (SMS) to your mobile number. ICSSC text messages may include: account alerts.</p>
            ...
            <p>If you have any questions or need assistance regarding our SMS communications, please reply with the keyword HELP. You can also email us at <a href="mailto:icssc@uci.edu">icssc@uci.edu</a>. If you have any questions regarding privacy, please read our Privacy Policy: <a href="https://studentcouncil.ics.uci.edu/privacy-policy" target="_blank" rel="noopener noreferrer">https://studentcouncil.ics.uci.edu/privacy-policy</a>.</p>
            ...
            <p><strong>ICSSC</strong><br />
            <strong>4208 DONALD BREN HALL</strong><br />
            <strong>Irvine, CA 92620</strong><br />
            <strong>United States</strong><br />
            <strong><a href="mailto:icssc@uci.edu">icssc@uci.edu</a></strong></p>
        </div>
    )
}
