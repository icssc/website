export default function Page() {
	return (
		<div className="prose max-w-4xl mx-auto p-6 space-y-4">
			...
			<p>
				<strong>Last updated:</strong> December 09, 2025
			</p>

			<h2>AGREEMENT TO OUR LEGAL TERMS</h2>

			<p>
				We are ICSSC (<strong>"Company"</strong>, <strong>"we"</strong>,{" "}
				<strong>"us"</strong>, <strong>"our"</strong>), a company registered in
				California, United States at 4208 DONALD BREN HALL, Irvine, CA 92620.
			</p>

			<p>
				We operate the website{" "}
				<a
					href="https://www.icssc.club"
					target="_blank"
					rel="noopener noreferrer"
				>
					https://www.icssc.club
				</a>{" "}
				(the <strong>"Site"</strong>), the mobile application ICSSC (the{" "}
			...
			<p>
				...
				<a href="mailto:icssc@uci.edu">icssc@uci.edu</a> or by mail to 4208
				DONALD BREN HALL, Irvine, CA 92620, United States.
			</p>

			<p>
				These Legal Terms constitute a legally binding agreement made between
				you, whether personally or on behalf of an entity (
				<strong>"you"</strong>), and ICSSC, concerning your access to and use of
			...
			<p>
				...
				<a href="mailto:icssc@uci.edu">icssc@uci.edu</a>, as stated in the email
			...
			<p>
				This document has been created with external references and the help of
				the{" "}
				<a
			...
			<ol>
				...
				<li>
					<a href="#sms">SMS TEXT MESSAGING</a>
				</li>
				<li>
			...
			<p>
				...
				<a href="mailto:icssc@uci.edu">icssc@uci.edu</a>. If we ever grant you
			...
			<p>
				...
				<strong>"Contributions"</strong>). Any Submission that is publicly
			...
			<p>
				...
				<strong>"Contributions"</strong>). Contributions may be viewable by
			...
			<p>
				...
				Apple Store or Google Play (each an <strong>"App Distributor"</strong>)
			...
			<p>
				...
				to other websites (<strong>"Third-Party Websites"</strong>) as well as
				...
				<strong>"Third-Party Content"</strong>). Such Third-Party Websites and
			...
			<p>
				...
				Arbitration Association (<strong>"AAA"</strong>) and, where appropriate,
				the AAA's Supplementary Procedures for Consumer Related Disputes (
				<strong>"AAA Consumer Rules"</strong>), both of which are available at
				the{" "}
				...
				arbitration will take place in Orange County, California. Except as
			...
			<p>
				...
				courts located in Orange County, California, and the Parties hereby
			...
			<p>
				By opting into any ICSSC text messaging program, you expressly consent
				to receive text messages (SMS) to your mobile number. ICSSC text
				messages may include: account alerts.
			</p>
			...
			<p>
				<strong>ICSSC</strong>
				<br />
				<strong>4208 DONALD BREN HALL</strong>
				<br />
				<strong>Irvine, CA 92620</strong>
				<br />
				<strong>United States</strong>
				<br />
				<strong>
					<a href="mailto:icssc@uci.edu">icssc@uci.edu</a>
				</strong>
			</p>
		</div>
	);
