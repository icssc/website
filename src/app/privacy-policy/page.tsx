	...
	return (
		<div className="prose max-w-4xl mx-auto p-6 space-y-4">
			...
			<p>
				...
				created with external references and the help of the{" "}
				<a
			...
			<ul>
				...
				<li>
					...
					"Us" or "Our" in this Agreement) refers to ICSSC.
				</li>
				<li>
				...
				<li>
					<strong>Website</strong> refers to ICSSC, accessible from
			...
			<ul>
				...
				<li>
					...
					to evaluate and improve our Service, products, services, and your
					experience.
				</li>
			</ul>
			...
			<p>
				Our Service's use and transfer to any other app of information received
